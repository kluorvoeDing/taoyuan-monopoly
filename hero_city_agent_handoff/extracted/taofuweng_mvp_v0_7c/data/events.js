window.TAOFUWENG_EVENTS = [
  { id: "hero_license_fee", name: "臨時執照規費", description: "臨時英雄執照續期，支付規費 1000。", type: "cash", target: "self", amount: -1000, negative: true },
  { id: "civilian_thanks", name: "市民感謝金", description: "巡邏時順手救了差點遲到的上班族，獲得感謝金 800。", type: "cash", target: "self", amount: 800 },
  ...
  { id: "villain_attack", name: "敵人襲擊", description: "敵人突襲，自己名下一塊最高級據點降 1 級。", type: "damage_highest_land", negative: true },
  ...
  { id: "support_upgrade", name: "支援科爆改週", description: "所有玩家下一次擴建費 -20%。", type: "upgrade_discount_all", value: 0.2, duration: 3 },
